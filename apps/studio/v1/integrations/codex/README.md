# IntelDomGob Studio Codex Integration

This directory contains the Codex plugin/skill bundle for IntelDomGob Studio.

## User Flow

1. Open IntelDomGob Studio Settings > Integrations.
2. Add a Codex Agent.
...
Codex must use `/api/codex/*` endpoints. SSH, Docker, direct Python imports, database queries, and MCP internals bypass IntelDomGob Studio Settings and must not be used for user data access.

# IntelDomGob Studio Claude Code Integration

This directory contains the Claude Code skill bundle for IntelDomGob Studio.
...
The token is scope-gated. Every tool surface is checked server-side in IntelDomGob Studio,

...
from src.constants import BRAND_NAME, COOKBOOK_STATE_FILE
        ...
        if 300 <= r.status_code < 400:
            ...
            if loc.startswith("/login") or "/login" in loc:
                return {
                    ...
                    "error": f"That is {BRAND_NAME}, not a model server. Use the Ollama URL, usually http://host.docker.internal:11434/v1 in Docker.",
                }

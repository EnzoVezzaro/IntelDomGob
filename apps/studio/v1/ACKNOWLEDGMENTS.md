...
IntelDomGob Studio stands on the shoulders of a lot of open-source work. This file
...
## Upstream project — Odysseus (AGPL-3.0)

**IntelDomGob Studio is a fork of [Odysseus](https://github.com/pewdiepie-archdaemon/odysseus)**,
a self-hosted AI workspace originally created by the Odysseus authors. The vast
majority of this codebase originates from Odysseus; IntelDomGob Studio is a
rebranded, customized distribution of that work.

- **Original project:** Odysseus — https://github.com/pewdiepie-archdaemon/odysseus
- **License:** GNU Affero General Public License v3.0 or later (AGPL-3.0-or-later)
- **Copyright:** © the Odysseus authors and contributors

Because Odysseus is licensed under the **AGPL-3.0**, IntelDomGob Studio is
distributed under the **same license** (see [`LICENSE`](LICENSE)). Per the AGPL:

- The complete corresponding source code of this modified version is made
  available to all users who interact with it over a network.
- The original copyright and license notices are preserved.
- These attribution and copyleft obligations carry forward to anyone who
  further modifies or redistributes IntelDomGob Studio.

Our sincere thanks to the Odysseus authors and contributors for building and
open-sourcing the foundation this project is built on.
...
- **[Tongyi DeepResearch](https://github.com/Alibaba-NLP/DeepResearch)** by
  **Alibaba-NLP / Tongyi Lab** — the multi-step deep-research agent pipeline.
  Copyright © Alibaba-NLP / Tongyi Lab. **Apache-2.0.** Adapted for IntelDomGob Studio's
...
and run alongside IntelDomGob Studio on `docker compose up`. They are not modified —
just composed.
...
IntelDomGob Studio talks to these over the network/API. They are **not** distributed
...
- **`caldav`** (Python lib) is **dual-licensed GPL-3.0-or-later OR Apache-2.0**.
  IntelDomGob Studio uses it under **Apache-2.0**, which is permissive and MIT-compatible.
...
Most of IntelDomGob Studio's code was written *with* AI models, not just by a human.

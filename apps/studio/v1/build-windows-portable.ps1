...
<#
  Build a portable Windows distribution for IntelDomGob Studio.

  Output layout:
    dist\IntelDomGob-Studio\IntelDomGob-Studio.exe
    dist\IntelDomGob-Studio\static\...
    dist\IntelDomGob-Studio\scripts\...
    dist\IntelDomGob-Studio\mcp_servers\...
    dist\IntelDomGob-Studio\services\hwfit\data\...
...
& $pyExe -m PyInstaller --noconfirm --clean --onedir --noconsole --icon=static/icon.ico --name IntelDomGob-Studio @dataArgs launcher.py
if ($LASTEXITCODE -ne 0) { Fail "PyInstaller build failed." }

Write-Host ""
Write-Host "Build complete." -ForegroundColor Green
Write-Host "Portable app folder: $PSScriptRoot\dist\IntelDomGob-Studio" -ForegroundColor Green

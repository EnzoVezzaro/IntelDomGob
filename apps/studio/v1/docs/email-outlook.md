...
IntelDomGob Studio email accounts currently use IMAP and SMTP with username/password
...
This is expected. IntelDomGob Studio does not support Microsoft OAuth or Graph Mail yet,

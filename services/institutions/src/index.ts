...
export { chamberApi, getComisiones, getComisionTipos, getComisionesByTipo, getIniciativaCount, getIniciativaGrupos, getIniciativaMaterias, getIniciativasFiltered, getIniciativaDetalle, getIniciativaCompleta, getIniciativaSub, getIniciativaSubRecurso, INICIATIVA_SUB_RECURSOS, getGruposParlamentarios, getSesiones, getLegislador } from "./chamber";
...
export { searchSenadores, listSenadoresByPeriodo, listSenadoresPeriodos, getSenador, SENATE_SCOPE_SENADORES, SENATE_PERIODOS } from "./senate/dspace";
export { getExpediente } from "./senate/dspace";
export type { SenadoExpediente, SenadoExpedienteDocumento } from "./senate/dspace";
export type { Senador } from "./senate/dspace";
